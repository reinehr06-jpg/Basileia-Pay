...
export function Topbar({ title, description }: TopbarProps) {
  return (
    <header className="h-[52px] 2xl:h-[68px] px-4 2xl:px-8 flex items-center justify-between sticky top-0 z-20 w-full transition-all duration-300 bg-background/50 backdrop-blur-md">
      {/* Search Bar - Professional & Expansive */}
      <div className="relative flex-1 group mr-4 2xl:mr-12">
