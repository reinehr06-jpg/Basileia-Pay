      ...
      <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 pt-1 w-full">
        <div className="space-y-0">
          <div className="flex items-center gap-3">
            <h1 className="text-[28px] 2xl:text-[34px] font-black tracking-tighter text-ink leading-none">Visão Geral</h1>
            <div className="h-6 w-px bg-border/60 mx-1" />
            <BarChart3 className="w-4 h-4 2xl:w-5 h-5 text-brand opacity-40" />
          </div>
        ...
        <div className="flex items-center gap-2">
          <div className="hidden sm:flex items-center gap-2 px-3 py-2 bg-success/5 border border-success/10 rounded-xl h-[40px] 2xl:h-[46px]">
            <div className="w-1.5 h-1.5 rounded-full bg-success animate-pulse shadow-[0_0_8px_rgba(22,163,74,0.4)]" />
            <span className="text-[9px] 2xl:text-[9.5px] font-black uppercase tracking-widest text-success/80">Sistemas operando</span>
          </div>
          
          <button className="flex items-center gap-2 px-4 2xl:px-5 py-2 2xl:py-2.5 bg-gradient-to-r from-brand to-brand-accent text-white rounded-xl text-[10.5px] 2xl:text-[11.5px] font-black shadow-lg shadow-brand/20 hover:shadow-brand/40 hover:-translate-y-0.5 transition-all active:translate-y-0 uppercase tracking-tight h-[40px] 2xl:h-[46px]">
            <Plus className="w-3 2xl:w-3.5 h-3 2xl:h-3.5 text-white/80" />
            Nova análise
          </button>
        </div>
      </header>

      {/* Main Content Grid - Maximum Utility Area (Responsive Widths) */}
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_310px] 2xl:grid-cols-[1fr_360px] gap-4 2xl:gap-6 items-start w-full">
        
        {/* Left Column - Operations & Financials (Dynamic 1fr) */}
        <div className="flex flex-col gap-4 2xl:gap-6 min-w-0 w-full">
        ...
        {/* Right Column - Intelligence & Health (Responsive Fixed Width) */}
        <div className="min-w-0 shrink-0 w-[310px] 2xl:w-[360px]">
