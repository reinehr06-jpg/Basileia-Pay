    ...
    <div x-data="{ locale: 'pt-BR' }">
        ...
        <section class="main-card">
            ...
            <div class="left-panel">
                ...
                <h1 class="plan-title">{{ $transaction->description ?? 'Plano Mensal' }}</h1>
            ...
            <div class="right-panel">
                ...
                <form method="POST" action="{{ route('checkout.process', $transaction->uuid) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-input" value="{{ $transaction->customer_email ?? '' }}" placeholder="seu@email.com" required>
                    ...
                    <button type="submit" class="cta-button">
                        Assinar Plano por R${{ number_format($transaction->amount, 2, ',', '.') }}
                    </button>
                </form>
